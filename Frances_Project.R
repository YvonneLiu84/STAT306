...
#####THIS IS the ONE WITH RANDOM RESIDUAL PLOT#########
X306 <- X306[-478,] #delete the row with AQI = 0
fit6 <- lm(log(X306$AQI)~X306$CO_24h+X306$NO2_24h+X306$O3_24h+X306$SO2_24h+X306$PM10_24h+X306$PM2.5_24h)
...
cat("Cp and adjr\n")
print(summ.exh6$cp)
print(summ.exh6$adjr) #max adjr = 0.4459
